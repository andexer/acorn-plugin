...
return [
    ...
    */
	...
	'manifests' => [
		'plugin' => [
			'path' => get_plugin_path('public'),
			'url' => get_plugin_uri('public'),
			'assets' => get_plugin_path('public/build/manifest.json'),
			'bundles' => get_plugin_path('public/build/entrypoints.json'),
		],
	],
];
